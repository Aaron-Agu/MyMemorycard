...
q6=Question("What is the 6 x 6?","36","28","16","8")
q7=Question("Who is Mario's love interst?","Peach","Daisy","Bowser","Yoshi")
q8 =Question("Who is Luigi's love interst?","Daisy","Peach","Wario","Bowser")
...
def check():
    if but_list[0].isChecked():
        ...
        label2.sexText("Incorrect. The answer is:")
        main_win.wrong +=1
...
label1 = QLabel("--When was Moscow founded?--")
...
b1=QRadioButton("1147")
b2=QRadioButton("1243")
b3=QRadioButton("1861")
b4=QRadioButton("There is no correct answer")
